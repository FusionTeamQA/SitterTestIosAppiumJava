...
public class SelectSitterViewProfile {
    public static void main(String[] args) throws MalformedURLException, InterruptedException {
        ...
        try {
            ...
            clicksitter.click();
            Thread.sleep(2000);
            driver.findElementByAccessibilityId("View Sitter Profile").click();
            Thread.sleep(1000);
            String JobDetails = driver.findElementByAccessibilityId("Sat, Dec 31st 4:30a - 7:30a").getText();
                    assertTrue(JobDetails.contains("Sat, Dec 31st 4:30a - 7:30a")); //отображение значения работы
            Thread.sleep(1000);
            String SelectButton = driver.findElementByXPath("(//XCUIElementTypeOther[@name='Select Sitter'])[1]").getText();
            assertTrue(SelectButton.contains("Select Sitter")); //отображение кнопки Select Sitter
            driver.quit();
            System.out.println("Sitter Profile is view");
